...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 27 18:33:37 2019
...
train_file = "./Data/train_test_1/simon_wifi(train).csv"     # both training set
test_file = "./Data/train_test_1/simon_wifi(test).csv"
x_train, y_train = data_shuffle(train_file)
x_test, y_test = data_shuffle(test_file)

reg = SVR(kernel='rbf', degree=3, C=1.0, epsilon=0.1)
...
visualization(Y_test=y_test, Y_pre=pre_test, suffix='svm')
# save the tar&pre into "./interim_output/test_output{*}.txt"
save_results(Y_test=y_test, Y_pre=pre_test, suffix='svm')  # baseline [200,200,200]
