...
# 本脚本处理xml数据，写入out_in_overall_*(*表示wifi维度).h5或out_in_overal_*(*表示wifi维度).txt文件中
...
#        self.save_overall_txt()
    ...
    #     t_filename = "./Data/background_results/out_in_" + os.path.splitext(filename)[0] + ".txt"
...
#        txt_filename = "../../Data/background_results/out_in_overall(gridsize2).txt"
        txt_filename = "../../out_in_overall_102.txt"
        write_text = np.hstack((self.f_outputs, self.f_inputs))
...
#        h5_filename = "../../Data/background_results/out_in_overall(gridsize2).h5"
        h5_filename = "../../out_in_overall_102.h5"
...
#file1 = "../../Data/background_results/out_in_overall(gridsize2).h5"
#file2 = "../../Data/background_results/out_in_overall(gridsize2).txt"
file1 = "../../out_in_overall_102.h5"
file2 = "../../out_in_overall_102.txt"
